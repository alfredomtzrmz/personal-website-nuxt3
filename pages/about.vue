<template>
  <div class="flex-col flex space-y-6">
    <div class="flex flex-col space-y-4">
      <h1
        class="dark:text-zinc-200 text-storm-400 text-4xl font-semibold xl:text-5xl"
      >
        About Alfredo
      </h1>
      <p class="font-medium dark:text-zinc-200 text-storm-400">
    ...
    <div class="flex-col flex space-y-6">
      ...
      >
        <h5 class="dark:text-zinc-200 text-storm-400 font-semibold">
          Manifesto.
        </h5>
        <p class="text-neutro-300 dark:text-neutro-400 text-sm">
